...
// 6 FRAUDULENT ORDER CHECKER NO2 use foreach to output orders starting with B which are 25x more likely to be fraudulent
string[] moreFraud = [ "B123", "C234", "A435", "C15", "B177", "G3003", "C235", "B179" ];

foreach(string fraud in moreFraud) {
